	...
	<div class="col-sm-12">
		<form action="<?=DOMAIN?>?c=<?=$controller?>&action=insert" method="post">
			...
			<div class="form-group">
				...
				<input type="number" name="ecr-tamano" id="ecr-tamano" class="form-control" required="">
			</div>

			<div class="form-group">
				<label for="ecr-banos">Baños:</label>
				<input type="number" name="ecr-banos" id="ecr-banos" class="form-control" required="">
			</div>

			<div class="form-group">
				<label for="ecr-parqueos">Parqueos:</label>
				<input type="number" name="ecr-parqueos" id="ecr-parqueos" class="form-control" required="">
			</div>

			<div class="form-group">
				<label for="ecr-habitaciones">Habitaciones:</label>
				<input type="number" name="ecr-habitaciones" id="ecr-habitaciones" class="form-control" required="">
			</div>

			<div class="form-group">
				<label for="ecr-precio">Precio:</label>
				<input type="number" name="ecr-precio" id="ecr-precio" class="form-control" required="">
			</div>
