...
;(function ( $, window, document, undefined ) {
    ...
    $.widget( "namespace.strength_meter" , {
        ...
        _create: function () {
            ...
            this.element.append('<input type="password" autocomplete="new-password" name="password" class="' + options.inputClass + '" "/>');
            ...
            this.element.append(
                ...
                <h4>La Contraseña debe tener por lo menos:</h4> \
                <ul> \
                <li data-criterion="length" class="valid">De 8 a 20 <strong>Caracteres permitidos</strong>.</li> \
                <li data-criterion="capital" class="valid">Debe tener al menos <strong>una letra en mayusculas</strong>.</li> \
                <li data-criterion="number" class="valid">Debe tener al menos <strong>un número</strong>.</li> \
                <li data-criterion="letter" class="valid">No se permiten espacios en blanco.</li> \
                </ul> \
                </div>');
